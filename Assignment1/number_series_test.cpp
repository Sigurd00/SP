...
TEST_CASE("operator+ is not skitzo")
{
    auto ns1 = number_series{1,2,3};
    auto ns2 = number_series{1,2,3,4};
    auto ns3 = ns1 + ns2;
    CHECK(ns3.get_numbers()[0] == 2);
    CHECK(ns3.get_numbers()[1] == 4);
    CHECK(ns3.get_numbers()[2] == 6);
    CHECK(ns3.get_numbers()[3] == 4);
}
